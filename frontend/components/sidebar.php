    ...
    <div class="sidebar__top">
        ...
        <nav class="nav" aria-label="Módulos">
            ...
            <a class="nav__item<?= $overviewActive ? ' active' : '' ?>" href="index.php" <?= $overviewActive ? ' aria-current="page"' : '' ?>>
                <span class="nav__icon"><svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div class="nav__group<?= $routinesActive ? ' is-active' : '' ?>" data-nav-group="rutinas">
                ...
                <div id="submenu-rutinas-ftth" class="nav__submenu" <?= $routinesActive ? '' : ' hidden' ?>>
                    <?php foreach ($routinePages as $page => $label): ?>
                        <a class="nav__subitem<?= $sidebarPage === $page ? ' active' : '' ?>"
                            href="<?= htmlspecialchars($page, ENT_QUOTES, 'UTF-8') ?>" <?= $sidebarPage === $page ? ' aria-current="page"' : '' ?>><?= htmlspecialchars($label, ENT_QUOTES, 'UTF-8') ?></a>
                    <?php endforeach; ?>
                </div>
            </div>
            ...
            <a class="nav__item<?= $sidebarPage === 'hfc.php' ? ' active' : '' ?>" href="hfc.php"
                <?= $sidebarPage === 'hfc.php' ? ' aria-current="page"' : '' ?>>
                <span class="nav__icon"><svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a class="nav__item<?= $sidebarPage === 'reportes.php' ? ' active' : '' ?>" href="reportes.php"
                <?= $sidebarPage === 'reportes.php' ? ' aria-current="page"' : '' ?>>
                <span class="nav__icon"><svg viewBox="0 0 24 24" aria-hidden="true">
                        <path d="M4 19V9m6 10V5m6 14v-7m4 7H2" />
                    </svg></span><span class="nav__text">Reportes</span>
            </a>
            <a class="nav__item<?= $sidebarPage === 'configuracion.php' ? ' active' : '' ?>" href="configuracion.php"
                <?= $sidebarPage === 'configuracion.php' ? ' aria-current="page"' : '' ?>>
                <span class="nav__icon"><svg viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    </svg></span><span class="nav__text">Configuración</span>
            </a>
        </nav>
        ...
        <div class="sidebar__footer">
            <div class="sidebar-user">
                ...
                <div class="sidebar-user__info"><strong>Administrador</strong><span>NOC Colombia</span></div>
            </div>
